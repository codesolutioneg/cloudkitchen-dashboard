...
export function AppShell() {
  ...
  return (
    <div className="flex min-h-screen w-full bg-background">
      <aside
        className={cn(
          "sticky top-0 flex h-screen shrink-0 flex-col border-r bg-sidebar transition-all duration-200",
        ...
        <div className="flex h-16 items-center gap-2.5 border-b px-4" style={{ borderColor: "var(--sidebar-border)" }}>
          ...
          {!collapsed && (
            <div className="flex flex-col leading-tight">
              <span className="text-[15px] font-bold text-sidebar-foreground">Cloud Kitchen</span>
        ...
        <header className="sticky top-0 z-30 flex h-16 items-center gap-4 border-b border-border bg-background/95 px-6 backdrop-blur">
          <div className="relative flex-1 max-w-md">
            ...
            <input
              type="text"
              placeholder="Search…"
              className="h-10 w-full rounded-[10px] border border-border bg-card pl-9 pr-3 text-sm outline-none placeholder:text-muted-foreground focus:border-primary focus:ring-2 focus:ring-primary/20"
            />
          </div>
