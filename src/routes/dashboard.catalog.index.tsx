...
function AssignmentsTab() {
  ...
  const cols: Column<CompanyCatalogAssignment>[] = [
    ...
    },
    {
      ...
      header: t("Menus"),
      cell: (r) => r.menu ? (
        <Link to="/dashboard/menus/$id" params={{ id: r.menu.menuId }} search={{ tab: "sections" }} className="inline-flex items-center gap-1 font-medium text-primary hover:underline">
