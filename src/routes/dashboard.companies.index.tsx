...
const TABS: Array<{ id: ApprovalStatus | "all"; label: string }> = [
  ...
  { id: "under_review", label: t("Under review") },
  { id: "approved", label: t("Approved") },
  { id: "rejected", label: t("Rejected") },
  { id: "resubmission_required", label: t("Resubmission") },
];
...
function CompaniesPage() {
  ...
  return (
    <>
      <PageHeader title={t("Companies")} description={t("Corporate clients and onboarding approval.")} />
      ...
      <DataTable columns={columns} rows={query.data?.items} loading={query.isLoading}
        ...
        emptyTitle={t("No companies")} emptyDescription={t("Corporate registrations will show here once submitted.")} />
